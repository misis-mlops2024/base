...
def main(params_path: str):
    ...
    X, y = sklearn.datasets.make_classification(n_samples=params.data_params.n_samples, n_features=params.data_params.n_features)
    ...
    train, test = sklearn.model_selection.train_test_split(data, test_size=params.data_params.test_size, random_state=params.random_state)
